...
<section class="frontend row justify-content-center"> 
    <h1 class="titulo col-md-12">Actualización de datos de la venta</h1>
    <div class="form col-md-8" id='formUpdateSale'>
        <h2 class="titulo-2">Ingrese los datos del animal</h2>
        <form class="form_data" method="post" action="{{ url('/sales/update/')}}">
            {{csrf_field()}}
            <div class="mb-3">
                ...
                <select class="form-control" id="sale_type" name="sale_type" required>
                    ...
                    <option value="{{$sale_type}}" selected>{{$sale_type}}</option>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="sale_date" name="sale_date" type="date"  value='{{ explode(' ', $sale_date)[0] }}' required>
            </div>
            <div class="mb-3">
            ...
            <input id="sale_id" name="sale_id" type="hidden" value="{{$sale_id}}">
